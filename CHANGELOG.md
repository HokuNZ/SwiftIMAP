...
- `IMAPCommand.SequenceSet.set(_:)` now requires a non-empty array (precondition) instead of silently producing UID `0`, which is invalid on the wire (#36).
