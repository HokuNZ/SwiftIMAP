...
struct Interactive: AsyncParsableCommand {
        ...
        do {
            ...
            while true {
                ...
                do {
                    ...
                    case "search":
                        if let mailbox = currentMailbox {
                            try await searchMessages(client: client, mailbox: mailbox, criteria: argument)
                        } else {
    ...
    private func searchMessages(client: IMAPClient, mailbox: String, criteria: String?) async throws {
        ...
        if let criteria = criteria {
            ...
            case "since":
                // Parse date - support simple formats like "7d" for 7 days ago
                var date: Date?
